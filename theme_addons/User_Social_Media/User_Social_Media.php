...
?>
    ...
    <div class="row">
        <div class="col-11">
            <h5 class="fw-bold"><?php esc_html_e('Add Your Social Media Links', 'hello-elementor-child'); ?></h5>
        </div>
        <div class="col-1">
            <?php if (!is_admin()) : ?>
    ...
    <?php if (!is_admin()) { ?>
        ...
        <?php } else { ?>
            ...
            <?php } ?>
            <tr>
                <th><label for="user_facebook"><?php esc_html_e('Facebook', 'hello-elementor-child'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label for="user_instagram"><?php esc_html_e('Instagram', 'hello-elementor-child'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label for="user_twitter"><?php esc_html_e('Twitter', 'hello-elementor-child'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label for="user_linkedin"><?php esc_html_e('Linkedin', 'hello-elementor-child'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label for="user_google"><?php esc_html_e('Google', 'hello-elementor-child'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label for="user_youtube"><?php esc_html_e('Youtube', 'hello-elementor-child'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label for="user_GitHub"><?php esc_html_e('Github', 'hello-elementor-child'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label for="user_StackOverFlow"><?php esc_html_e('Stack Overflow', 'hello-elementor-child'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label for="user_whatsapp"><?php esc_html_e('WhatsApp', 'hello-elementor-child'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label for="user_other"><?php esc_html_e('Other Links', 'hello-elementor-child'); ?></label></th>
                <td>
