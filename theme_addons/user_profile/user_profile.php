    ...
    <?php if (!is_user_logged_in()) { ?>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="user_login-tab" data-bs-toggle="tab" data-bs-target="#user_login" type="button" role="tab" aria-controls="user_login" aria-selected="true"><?php esc_html_e('Login', 'hello-elementor-child'); ?></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " id="user_register-tab" data-bs-toggle="tab" data-bs-target="#user_register" type="button" role="tab" aria-controls="user_register" aria-selected="true"><?php esc_html_e('Site Register', 'hello-elementor-child'); ?></button>
            </li>
            <li class="nav-item " role="presentation">
                <button class="nav-link" id="forgot_psw-tab" data-bs-toggle="tab" data-bs-target="#forgot_psw" type="button" role="tab" aria-controls="forgot_psw" aria-selected="false"><?php esc_html_e('Forgot Password', 'hello-elementor-child'); ?></button>
            </li>
        </ul>
