...
if (is_user_logged_in() && get_current_user_id() === $userId) { ?>
    ...
    <div class="float-lg-end AJDWP_update_profile_modal " data-bs-toggle="modal" data-bs-target="#edit_profile_Modal" style="cursor:pointer;color:#ff2819;">
        <span><?php esc_html_e('Edit', 'hello-elementor-child'); ?> <b><?php echo get_the_author(); ?></b> <?php esc_html_e('Profile ?', 'hello-elementor-child'); ?></span> <span class="fa fa-edit fa-2x m-3"></span>
    </div>
                        ...
                        <fieldset>
                            <form method="post" action="">
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    <label for="toggle-email" class="fw-bold"><?php esc_html_e('Show Email:', 'hello-elementor-child'); ?></label>
                                    ...
                                    <label for="toggle-phone" class="fw-bold"><?php esc_html_e('Show Phone Number: ', 'hello-elementor-child'); ?></label>
                                    <div class="toggle-switch">
                                ...
                                <h5 class="AJDWP_header my-3 fw-bold"><?php esc_html_e('Change Your Profile Image', 'hello-elementor-child'); ?></h5>
                                <div class="my-3">

                                    <div id="set-user-avatar-container">

                                        <button id="open-media-library"><?php esc_html_e('My Gallery', 'hello-elementor-child'); ?></button>
                                        ...
                                        <label for="delete_avatar">
                                            <input type="checkbox" name="delete_avatar" id="delete_avatar"> <?php esc_html_e('Delete Avatar', 'hello-elementor-child'); ?>
                                        </label>
                                        <br>
                                ...
                                <div class="row">
                                    <div class="col-11">
                                        <h5 class="modal-title text-dark fw-bold"><?php esc_html_e('Update Your Profile Details: ', 'hello-elementor-child'); ?> </h5>
                                    </div>
                                    <div class="col-1">
                                ...
                                <div class="edit-user-detals" id="edit-user-details" style="display: block;">
                                    <label for="first_name" class="fw-bold"><?php esc_html_e('First Name: ', 'hello-elementor-child'); ?></label>
                                    ...
                                    <label for="last_name" class="fw-bold"><?php esc_html_e('Last Name: ', 'hello-elementor-child'); ?></label>
                                    ...
                                    <label for="display_name" class="fw-bold"><?php esc_html_e('Display Name: ', 'hello-elementor-child'); ?></label>
                                    ...
                                    <label for="phone_number" class="fw-bold"><?php esc_html_e('Phone Number: ', 'hello-elementor-child'); ?></label>
                                    ...
                                    <label for="user_bio" class="fw-bold"><?php esc_html_e('Bio: ', 'hello-elementor-child'); ?></label>
                                ...
                                <input type="submit" value="<?php echo esc_attr__('Update', 'hello-elementor-child'); ?>" name="submit_profile_update">
                            </form>
