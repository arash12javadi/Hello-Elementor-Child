...
<!-- ---------------- quilck login shortcode in the body ---------------- -->
<?php 
...
<footer class="bg-dark text-center text-white mt-5 ">
        ...
        <div class="font-weight-bold h5 pb-2 pt-3">
                ...
                <?php if(get_user_meta( 1, 'user_facebook', true)){ ?>
                        <!-- user_facebook -->
                        <a href="<?php echo get_user_meta( 1, 'user_facebook', true); ?>" target="_blank"  ><i class="fa-brands fa-facebook-f fa-2x mx-3" style="color: #3b5998;"></i></a>
                <?php } ?>


                <?php if(get_user_meta( 1, 'user_twitter', true)){ ?>
                        <!-- user_twitter -->
                        <a href="<?php echo get_user_meta( 1, 'user_twitter', true); ?>" target="_blank" ><i class="fa fa-twitter fa-2x mx-3" style="color: #55acee;"></i></a>
                <?php } ?>


                <?php if(get_user_meta( 1, 'user_google', true)){ ?>
                        <!-- user_google -->
                        <a href="<?php echo get_user_meta( 1, 'user_google', true); ?>" target="_blank" ><i class="fa fa-google fa-2x mx-3" style="color: #dd4b39;"></i></a>
                <?php } ?>


                <?php if(get_user_meta( 1, 'user_instagram', true)){ ?>
                        <!-- user_instagram -->
                        <a href="<?php echo get_user_meta( 1, 'user_instagram', true); ?>" target="_blank" ><i class="fa fa-instagram fa-2x mx-3" style="color: #ac2bac;"></i></a>
                <?php } ?>


                <?php if(get_user_meta( 1, 'user_linkedin', true)){ ?>
                        <!-- user_linkedin -->
                        <a href="<?php echo get_user_meta( 1, 'user_linkedin', true); ?>" target="_blank" ><i class="fa fa-linkedin fa-2x mx-3" style="color: #0082ca;"></i></a>
                <?php } ?>


                <?php if(get_user_meta( 1, 'user_youtube', true)){ ?>
                        <!-- user_youtube -->
                        <a href="<?php echo get_user_meta( 1, 'user_youtube', true); ?>" target="_blank" ><i class="fa fa-youtube fa-2x mx-3" style="color: #c4302b;"></i></a>
                <?php } ?>

                <?php if(get_user_meta( 1, 'user_GitHub', true)){ ?>
                        <!-- user_GitHub -->
                        <a href="<?php echo get_user_meta( 1, 'user_GitHub', true); ?>" target="_blank" ><i class="fa-brands fa-github fa-2x mx-3" style="color: #2dba4e;"></i></a>
                <?php } ?>

                <?php if(get_user_meta( 1, 'user_StackOverFlow', true)){ ?>
                        <!-- user_StackOverFlow -->
                        <a href="<?php echo get_user_meta( 1, 'user_StackOverFlow', true); ?>" target="_blank" ><i class="fa-brands fa-stack-overflow fa-2x mx-3" style="color: #F48024;"></i></a>
                <?php } ?>


                <?php if(get_user_meta( 1, 'user_whatsapp', true)){ ?>
                        <!-- user_whatsapp -->
                        <a href="<?php echo get_user_meta( 1, 'user_whatsapp', true); ?>" target="_blank" ><i class="fa fa-whatsapp fa-2x mx-3" style="color: #25D366;"></i></a>
                <?php } ?>


                <?php if(get_user_meta( 1, 'user_other', true)){ ?>
                        <!-- user_other -->
                        <a href="<?php echo get_user_meta( 1, 'user_other', true); ?>" target="_blank" ><i class="fa fa-link fa-2x mx-3" style="color: gold;"></i></a>
                <?php } ?>
        ...
        <div class="text-center py-3" style="background-color: rgba(0, 0, 0, 0.2);">
                ...
                <a class="text-white" href="https://arashjavadi.com/"> (arashjavadi.com)</a>
        </div>
        <!-- Copyright -->
